  ...
  return (
    <div className='container-fluid'>
      ...
      <div id="grid">
        ...
        <div id="intro">
          {!Number.isInteger(targetCupIndex) && <h2>The page introduces 12 types of ice creams around the world! Click on the thumbnails to  find out more about diffrent ice creams.</h2>}
        </div>
      </div>
    </div>)
}
